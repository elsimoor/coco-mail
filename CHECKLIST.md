```markdown
# Cocoinbox Feature Checklist (initial)
...
- Identity & Privacy Controls: todo
- Admin Dashboard: todo
- Realtime Notifications: todo
- Audit Logs & Exports: todo
- GraphQL API: todo
- Client-side Dashboard Layout: todo
- Testing: todo
- Infrastructure notes: todo
```